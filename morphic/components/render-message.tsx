...
export function RenderMessage({
  ...
  // Check if this message has been corrected
  const isCorrected = 'corrected' in message && message.corrected === true
  ...
  return (
    <>
      ...
      {/* Fallback for when message.parts is undefined but we have content */}
      {(!message.parts || message.parts.length === 0) && message.content.length > 0 && (
        <AnswerSection
          key={`${messageId}-text-fallback`}
